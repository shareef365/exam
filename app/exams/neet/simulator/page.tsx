...
export default function NEETSimulator() {
  ...
  const [timeLeft, setTimeLeft] = useState(12000) // 3 hours 20 minutes in seconds
  ...
  // Get exam data for NEET
  const examData = getExamData("neet")
  ...
  const handleNextQuestion = () => {
    ...
    if (currentQuestion < sectionQuestions.length - 1) {
      ...
      setCurrentSection("mathematics") // In NEET, this would be "biology"
      setCurrentQuestion(0)
    }
  }
  ...
  const handleSubmit = () => {
    try {
      ...
      const result = calculateResults("neet", selectedAnswers)
      result.timeSpent = 12000 - timeLeft // Calculate actual time spent
      ...
      router.push(`/exams/neet/results?session=${result.id}`)
    } catch (error) {
    ...
    <div ref={examContainerRef} className="flex min-h-screen flex-col bg-[#f0f4f8]">
      ...
      <AlertDialog open={isInstructionsOpen} onOpenChange={setIsInstructionsOpen}>
        <AlertDialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <AlertDialogHeader className="bg-[#1a237e] text-white p-2">
            <AlertDialogTitle className="text-xl font-bold">Please read the instructions carefully</AlertDialogTitle>
          </AlertDialogHeader>

          <div className="space-y-4 my-4 p-4">
            <h3 className="font-bold text-lg">General Instructions:</h3>
            <ol className="list-decimal pl-5 space-y-2">
              <li>Total duration of NEET (UG) is 200 minutes.</li>
              <li>
            ...
            <h3 className="font-bold text-lg mt-6">Navigating to a Question:</h3>
            <ol className="list-decimal pl-5 space-y-2">
              <li>
            ...
            <h3 className="font-bold text-lg mt-6">Answering a Question:</h3>
            <ol className="list-decimal pl-5 space-y-2">
              <li>
            ...
            <h3 className="font-bold text-lg mt-6">Navigating through sections:</h3>
            <ol className="list-decimal pl-5 space-y-2">
              <li>
          ...
          <AlertDialogFooter>
            <AlertDialogAction className="bg-[#1a237e] hover:bg-[#0d1257]">I am ready to begin</AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
      ...
      <header className="sticky top-0 z-10 bg-white border-b shadow-sm">
        ...
        <div className="flex items-center justify-between px-4 py-2 bg-[#f0f4f8]">
          <div>
          ...
          <div className="flex items-center">
            ...
            <div className="bg-[#1a237e] text-white px-2 py-1 rounded text-sm font-mono">{formatTime(timeLeft)}</div>
          </div>
        </div>
      </header>
      ...
      <div className="flex flex-1">
        ...
        <div className="w-[300px] bg-white border-l p-4">
          <div className="space-y-4">
            ...
            <div>
              <div className="flex justify-between items-center bg-[#1a237e] text-white px-3 py-1 rounded-t-md">
                <h3 className="text-sm font-medium">Physics</h3>
                <span className="text-xs">(1 to 45)</span>
              </div>
              <div className="border border-t-0 rounded-b-md p-2">
                <div className="grid grid-cols-5 gap-2">
                  {examData.sections.physics.questions.slice(0, 45).map((q, index) => (
                    <Button
                      key={q.id}
                      variant="outline"
                      size="sm"
            ...
            <div>
              <div className="flex justify-between items-center bg-[#1a237e] text-white px-3 py-1 rounded-t-md">
                ...
                <span className="text-xs">(46 to 90)</span>
              </div>
              <div className="border border-t-0 rounded-b-md p-2">
                <div className="grid grid-cols-5 gap-2">
                  {examData.sections.chemistry.questions.slice(0, 45).map((q, index) => (
                    <Button
                      key={q.id}
                      variant="outline"
                      size="sm"
            ...
            <div>
              <div className="flex justify-between items-center bg-[#1a237e] text-white px-3 py-1 rounded-t-md">
                <h3 className="text-sm font-medium">Biology</h3>
                <span className="text-xs">(91 to 180)</span>
              </div>
              <div className="border border-t-0 rounded-b-md p-2">
                <div className="grid grid-cols-5 gap-2">
                  {examData.sections.mathematics.questions.slice(0, 45).map((q, index) => (
                    <Button
                      key={q.id}
                      variant="outline"
                      size="sm"
      ...
      <AlertDialog open={isExitDialogOpen} onOpenChange={setIsExitDialogOpen}>
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction onClick={() => router.push(`/exams/neet`)} className="bg-[#f44336] hover:bg-[#d32f2f]">
              Exit Exam
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
